...
app.get('/bank/:id', function(req, res){    
	...
	var matchedBank = _.findWhere(bank, {id: bankId});  
...
app.post('/bank', function(req, res){         
	...
	body.potencial_sum = Math.round(body.money+body.money*body.percent_for_year*body.period_day/365/100);  
...
app.delete('/bank/:id', function(req,res){     
	...
	if(!matchedBank){  
		...
		bank = _.without(bank, matchedBank); 
		res.json(matchedBank);
	}
});
